    ...
    return (
        <div className="sec-text leading-8 text-[0.800rem] md:text-sm xl:text-base">
            ...
            <ul className="mt-3 list-disc list-inside leading-8">
                ...
                <li>
                    Designs with maintainability and long-term growth in mind
                </li>
                <li>
                    Approaches development with structure and long-term clarity
                </li>
                <li>
                    Values intuitive user experience supported by solid
                    architecture
                </li>
            </ul>
        </div>
